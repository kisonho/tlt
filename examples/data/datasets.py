...
class Dataset(abc.ABC):
    ...
    def __init__(self, batch_size: int, root_dir: str = os.path.normpath("~/Documents/Data"), workers: Optional[int] = os.cpu_count()) -> None:
        ...
        self._train_transforms, self._val_transforms = self._get_transforms()
    ...
    def _get_transforms(self) -> Tuple[transforms.Compose, transforms.Compose]:
        """
        Get the transforms of image

        - Parameters:
            - normalize: A `bool` flag of if normalize the image
        - Returns: A `tuple` of `torchvision.Transforms.Compose` for training transforms and `torchvision.Transforms.Compose` for testing transforms
        """
...
class CIFAR10(Dataset):
    ...
    def _get_dataset(self, dataset_dir: str = os.path.normpath("~/Documents/Data/")) -> Tuple[torchvision.datasets.CIFAR10, torchvision.datasets.CIFAR10]:
        ...
        trainset = torchvision.datasets.CIFAR10(os.path.join(dataset_dir, "train"), train=True, transform=self._train_transforms, target_transform=None, download=True)
        testset = torchvision.datasets.CIFAR10(os.path.join(dataset_dir, "test"), train=False, transform=self._val_transforms, target_transform=None, download=True)
...
class CIFAR100(Dataset):
    ...
    def _get_dataset(self, dataset_dir: str = os.path.normpath("~/Documents/Data/")) -> Tuple[torchvision.datasets.CIFAR100, torchvision.datasets.CIFAR100]:
        ...
        trainset = torchvision.datasets.CIFAR100(os.path.join(dataset_dir, "train"), train=True, transform=self._train_transforms, target_transform=None, download=True)
        testset = torchvision.datasets.CIFAR100(os.path.join(dataset_dir, "test"), train=False, transform=self._val_transforms, target_transform=None, download=True)
        return trainset, testset
...
class Cityscapes(Dataset):
    ...
    def _get_dataset(self, dataset_dir: str = os.path.normpath("~/Documents/Data/")) -> Tuple[TorchDataset, TorchDataset]:
        trainset = torchvision.datasets.Cityscapes(dataset_dir, transforms=self._train_transforms)
        self._valset = torchvision.datasets.Cityscapes(dataset_dir, split="val", transforms=self._val_transforms)
        testset = torchvision.datasets.Cityscapes(dataset_dir, split="val", transforms=self._val_transforms)
        return trainset, testset
...
class ImageNet(Dataset):
    ...
    def _get_transforms(self, image_size: int) -> Tuple[transforms.Compose, transforms.Compose]:
    ...
    def _get_dataset(self, dataset_dir: str = os.path.normpath('~/Documents/Data/')) -> Tuple[torchvision.datasets.ImageNet, torchvision.datasets.ImageNet]:
        ...
        trainset = torchvision.datasets.ImageNet(os.path.join(dataset_dir, 'train'), split='train', transform=self._train_transforms, target_transform=None)
        valset = torchvision.datasets.ImageNet(os.path.join(dataset_dir, 'val'), split='val', transform=self._val_transforms, target_transform=None)
...
class MNIST(Dataset):
    ...
    def _get_dataset(self, dataset_dir: str = os.path.normpath("~/Documents/Data/")) -> Tuple[torchvision.datasets.MNIST, torchvision.datasets.MNIST]:
        ...
        trainset = torchvision.datasets.MNIST(os.path.join(dataset_dir, "train"), train=True, transform=self._train_transforms, target_transform=None, download=True)
        testset = torchvision.datasets.MNIST(os.path.join(dataset_dir, "test"), train=False, transform=self._val_transforms, target_transform=None, download=True)
        return trainset, testset
...
class SVHN(Dataset):
    ...
    def _get_dataset(self, dataset_dir: str = os.path.normpath("~/Documents/Data/")) -> Tuple[torchvision.datasets.SVHN, torchvision.datasets.SVHN]:
        ...
        trainset = torchvision.datasets.SVHN(dataset_dir, split="train", transform=self._train_transforms, target_transform=None, download=True)
        testset = torchvision.datasets.SVHN(dataset_dir, split="test", transform=self._val_transforms, target_transform=None, download=True)
        return trainset, testset
...
class VOCSegmentation(Dataset):
    ...
    def _get_transforms(self) -> Tuple[transforms.Compose, transforms.Compose]:
        normalize = transforms.SegmentationNormalize(mean=[0.485, 0.456, 0.406], std=[0.229, 0.224, 0.225])
        train_transform = transforms.SegmentationCompose([
        ...
        test_transform = transforms.SegmentationCompose([
    ...
    def _get_dataset(self, dataset_dir: str = os.path.normpath("~/Documents/Data/")) -> Tuple[TorchDataset, TorchDataset]:
        ...
        trainset = torchvision.datasets.VOCSegmentation(dataset_dir, transforms=self._train_transforms, download=True)
        self._valset = torchvision.datasets.VOCSegmentation(dataset_dir, image_set="val", transforms=self._val_transforms, download=True)
        testset = torchvision.datasets.VOCSegmentation(dataset_dir, year="2007", image_set="test", transforms=self._val_transforms, download=True)
        return trainset, testset
